    ...
    <div style={{ minHeight:'100vh',background:'#ffffff',fontFamily:"'Plus Jakarta Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ background:'linear-gradient(135deg,#0F2A4A,#1a3a5c)',padding:'48px 24px 40px' }}>
        <div style={{ maxWidth:'1100px',margin:'0 auto',display:'flex',alignItems:'center',gap:'16px' }}>
          ...
          <div>
            <h1 style={{ fontFamily:"'Syne',sans-serif",fontSize:'clamp(24px,3vw,36px)',fontWeight:800,color:'white',margin:0 }}>Tip Calculator</h1>
      ...
      <div style={{ maxWidth:'680px',margin:'0 auto',padding:'36px 24px' }}>
        <div style={{ background:'white',border:'1.5px solid #e2e8f0',borderRadius:'20px',padding:'32px',boxShadow:'0 8px 32px rgba(15,42,74,0.08)' }}>
          ...
          <div style={{ marginBottom:'28px' }}>
            ...
            <div style={{ display:'flex',alignItems:'center',gap:'16px' }}>
              ...
              <div style={{ textAlign:'center',minWidth:'60px' }}>
                <div style={{ fontFamily:"'Syne',sans-serif",fontSize:'32px',fontWeight:800,color:'#0F2A4A',lineHeight:1 }}>{people}</div>
          ...
          <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px' }}>
            <div style={{ background:'#FFF7ED',border:'2px solid #FED7AA',borderRadius:'14px',padding:'18px',textAlign:'center' }}>
              ...
              <div style={{ fontFamily:"'Syne',sans-serif",fontSize:'32px',fontWeight:800,color:'#C2410C' }}>${tip.toFixed(2)}</div>
            </div>
            <div style={{ background:'#F0FDF4',border:'2px solid #BBF7D0',borderRadius:'14px',padding:'18px',textAlign:'center' }}>
              ...
              <div style={{ fontFamily:"'Syne',sans-serif",fontSize:'32px',fontWeight:800,color:'#166534' }}>${total.toFixed(2)}</div>
            </div>
            {people>1 && <>
              <div style={{ background:'#EFF6FF',border:'2px solid #BFDBFE',borderRadius:'14px',padding:'18px',textAlign:'center' }}>
                ...
                <div style={{ fontFamily:"'Syne',sans-serif",fontSize:'28px',fontWeight:800,color:'#1D4ED8' }}>${tipPer.toFixed(2)}</div>
              </div>
              <div style={{ background:'#0F2A4A',borderRadius:'14px',padding:'18px',textAlign:'center' }}>
                ...
                <div style={{ fontFamily:"'Syne',sans-serif",fontSize:'28px',fontWeight:800,color:'white' }}>${perP.toFixed(2)}</div>
              </div>
            </>}
            {people===1 && (
              <div style={{ gridColumn:'1/-1',background:'linear-gradient(135deg,#0F2A4A,#1a3a5c)',borderRadius:'14px',padding:'20px',textAlign:'center' }}>
                ...
                <div style={{ fontFamily:"'Syne',sans-serif",fontSize:'40px',fontWeight:800,color:'white' }}>${total.toFixed(2)}</div>
              </div>
            )}
          </div>
        </div>
        ...
        <div style={{ marginTop:'36px' }}>
          <h2 style={{ fontFamily:"'Syne',sans-serif",fontSize:'20px',fontWeight:700,color:'#0F2A4A',marginBottom:'14px' }}>Related Tools</h2>
