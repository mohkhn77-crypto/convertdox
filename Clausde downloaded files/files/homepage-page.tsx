    ...
    <div style={{ minHeight:'100vh', background:'#ffffff', fontFamily:"'Plus Jakarta Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ background:'linear-gradient(135deg,#0F2A4A 0%,#1a3a5c 100%)',padding:'72px 24px 64px',textAlign:'center',position:'relative',overflow:'hidden' }}>
        ...
        <div style={{ maxWidth:'800px',margin:'0 auto',position:'relative' }}>
          ...
          {/* Headline */}
          <h1 style={{ fontFamily:"'Syne',sans-serif",fontSize:'clamp(32px,5vw,58px)',fontWeight:800,color:'white',lineHeight:1.15,letterSpacing:'-0.5px',marginBottom:'18px' }}>
      ...
      <div id="tools" style={{ maxWidth:'1200px',margin:'0 auto',padding:'56px 24px' }}>
        ...
        <div style={{ marginBottom:'32px' }}>
          ...
          <h2 style={{ fontFamily:"'Syne',sans-serif",fontSize:'clamp(24px,3vw,34px)',fontWeight:800,color:'#0F2A4A',margin:'0 0 8px',letterSpacing:'-0.3px' }}>Free Online Tools</h2>
